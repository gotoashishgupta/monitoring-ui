import { ITaskGroup, ITask, IStatus, IFlattenedTask } from "#wf-local/store/index";
export const getFlattenedTasks = (service: string | undefined, status: IStatus = {}): IFlattenedTask[] | never[] => {

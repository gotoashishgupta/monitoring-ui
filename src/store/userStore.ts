...
export const useUserInfo = (selector: (state: UserStore) => any) => useUserStore(selector);
export const useUserActions = (selector: (state: UserStore) => any) => useUserStore(selector);
